...
var __vue_render__$4 = function __vue_render__() {
  ...
  }), _vm._ssrNode(" " + (!_vm.readOnly ? "<input" + _vm._ssrAttr("placeholder", _vm.placeholder) + _vm._ssrAttr("value", _vm.newTag) + " class=\"tag-input\" data-v-ad619840>" : "<!---->") + " <i class=\"el-icon-close icon-close\" data-v-ad619840></i>")], 2);
};
...
var __vue_inject_styles__$4 = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-ad619840_0", {
    source: ".el-form-item.is-error .el-input-tag[data-v-ad619840]{border-color:#f56c6c}.input-tag-wrapper[data-v-ad619840]{position:relative;font-size:14px;background-color:#fff;background-image:none;border-radius:4px;border:1px solid #dcdfe6;box-sizing:border-box;color:#606266;display:inline-block;outline:0;padding:0 10px 0 5px;transition:border-color .2s cubic-bezier(.645,.045,.355,1);width:100%}.el-tag[data-v-ad619840]{margin-right:4px}.tag-input[data-v-ad619840]{min-height:30px;background:0 0;border:0;font-size:inherit;outline:0;padding-left:0;width:100px}.el-input-tag[data-v-ad619840]{padding-top:3px;padding-bottom:3px;min-height:42px}.el-input-tag--mini[data-v-ad619840]{min-height:28px;line-height:28px;font-size:12px}.el-input-tag--small[data-v-ad619840]{min-height:32px;line-height:32px}.el-input-tag--medium[data-v-ad619840]{min-height:36px;line-height:36px}.icon-close[data-v-ad619840]{position:absolute;right:5px;top:50%;transform:translateY(-50%)}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__$4 = "data-v-ad619840";
/* module identifier */

var __vue_module_identifier__$4 = "data-v-ad619840";
/* functional template */
...
var script = {
  ...
  watch: {
    'store.selectKeys': {
      handler: function handler(val) {
        ...
        this.$nextTick(function () {
          _this.$refs.tree.setCheckedKeys([]); // TODO: 直接使用setCheckedKeys(val)会导致无法选中，需要遍历使用setChecked
  ...
  methods: {
    ...
    currentChange: function currentChange(checkItem, checkObj) {
      ...
      treeData.selectNodes = checkObj.checkedNodes; // TODO: 需要使用setTimeout，否则无法清空
    ...
    clear: function clear() {
      ...
      this.$refs.tree.setCheckedKeys([]); // TODO: 需要使用setTimeout，否则无法清空
...
var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-8e3349b8_0", {
    source: ".container[data-v-8e3349b8]{position:relative;display:inline-block;width:100%}[data-v-8e3349b8] .popper{margin-top:0;box-sizing:border-box;width:100%;padding:0}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__ = "data-v-8e3349b8";
/* module identifier */

var __vue_module_identifier__ = "data-v-8e3349b8";
/* functional template */
...
var __vue_component__$1 = __vue_component__;Vue__default["default"].use(ElementUI__default["default"]);var components$1=/*#__PURE__*/Object.freeze({__proto__:null,Vue2SelectTreeSample:__vue_component__$1});var install = function installVue2SelectTree(Vue) {
...
var components=/*#__PURE__*/Object.freeze({__proto__:null,'default':install,Vue2SelectTreeSample:__vue_component__$1});// only expose one global var, with component exports exposed as properties of
