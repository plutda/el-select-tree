...
const __vue_scope_id__$4 = "data-v-ad619840";
/* module identifier */
...
class Node {
  ...
  getChildren() {
    let forceInit = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
    // this is data
...
class TreeStore {
  ...
  _setCheckedKeys(key) {
    let leafOnly = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    let checkedKeys = arguments.length > 2 ? arguments[2] : undefined;
...
var script = {
  ...
  watch: {
    'store.selectKeys': {
      handler(val) {
        this.$nextTick(() => {
          this.$refs.tree.setCheckedKeys([]); // TODO: 直接使用setCheckedKeys(val)会导致无法选中，需要遍历使用setChecked
...
const __vue_scope_id__ = "data-v-8e3349b8";
/* module identifier */
...
var components = /*#__PURE__*/Object.freeze({
  __proto__: null,
  Vue2SelectTreeSample: __vue_component__$1
});
...
export { __vue_component__$1 as Vue2SelectTreeSample, install as default };
